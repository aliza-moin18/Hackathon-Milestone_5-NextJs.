    ...
    {/* Get in Touch */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 px-10 md:px-20 mt-20">
        <div>
          ...
          <p className="text-gray-600"> Lorem ipsum dolor sit amet saepe ad voluptatem, vero reiciendis reprehenderit incidunt dolor autem, sint dolores quas fugit. </p>
          <form>
            <div className="mb-4">
              <label
                htmlFor="name"
           ...
           <Button className="text-white px-9 py-6 font-bold hover:bg-pink-600 transition-all duration-300"> Send Mail </Button>
          </form>
        </div>
